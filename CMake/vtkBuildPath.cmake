...
if (NOT CMAKE_CONFIGURATION_TYPES OR NOT CMAKE_VERSION VERSION_LESS "2.8.12")
  ...
  if(VTK_WRAP_PYTHON)
    ...
    string(CONCAT PATH_TEMP "${VTK_CURRENT_BINARY_DIR}/Wrapping/Python" PATH_SEPARATOR "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}${cfg_subdir}")
    string(REPLACE "xxx_add_path" PATH_TEMP PATH_TEMP "${PATH_FORMAT}")
