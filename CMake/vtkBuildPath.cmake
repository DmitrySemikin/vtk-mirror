...
if(WIN32 OR UNIX)
  ...
  # write to file
  file(WRITE "${VTK_BINARY_DIR}/${VTK_PATH_SHELL_SCRIPT}" "${PATH_LINES}")

  if(VTK_WRAP_PYTHON)
  # FOR THE PYTHONPATH VARIABLE, if PYTHON is wrapped
  # replace the path to the python-specific files
    set(PATH_TEMP "${VTK_BINARY_DIR}/Wrapping/Python${PATH_SEPARATOR}${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${CMAKE_CFG_INTDIR}")
  ...
  # apped the line to the file
    file(APPEND "${VTK_BINARY_DIR}/${VTK_PATH_SHELL_SCRIPT}" "${PATH_TEMP}")
  endif()
