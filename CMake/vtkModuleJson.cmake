...
function (vtk_module_json)
  ...
  foreach (_vtk_json_module IN LISTS _vtk_json_MODULES)
    ...
    if("${_vtk_json_module}" STREQUAL "VTK::InteractionStyle")
      string(APPEND _vtk_json_contents "\"description\": \"${_vtk_json_description} interact with a scene\", ")
    elseif("${_vtk_json_module}" STREQUAL "VTK::RenderingUI")
      string(APPEND _vtk_json_contents "\"description\": \"${_vtk_json_description} Win32 Windows and Rendering\", ")
    elseif("${_vtk_json_module}" STREQUAL "VTK::RenderingFreeType")
      string(APPEND _vtk_json_contents "\"description\": \"${_vtk_json_description} Free Type Text routines\", ")
    elseif("${_vtk_json_module}" STREQUAL "VTK::RenderingGL2PSOpenGL2")
      string(APPEND _vtk_json_contents "\"description\": \"${_vtk_json_description} export a scene as a PostScript file\", ")
    else()
