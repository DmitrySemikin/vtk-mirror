...
function (vtk_module_json)
  ...
  foreach (_vtk_json_module IN LISTS _vtk_json_MODULES)
    ...
    if("${_vtk_json_module}" STREQUAL "VTK::InteractionStyle")
      string(APPEND _vtk_json_contents "\"description\": \"${_vtk_json_description} needed to allow the user to interact with (rotate, pan, etc.) objects in the scene independent of each other\", ")
    elseif("${_vtk_json_module}" STREQUAL "VTK::RenderingUI")
      string(APPEND _vtk_json_contents "\"description\": \"${_vtk_json_description} needed if vtkRenderWindowInteractor is used\", ")
    elseif("${_vtk_json_module}" STREQUAL "VTK::RenderingFreeType")
      string(APPEND _vtk_json_contents "\"description\": \"${_vtk_json_description} needed if text rendering is used\", ")
    else()
