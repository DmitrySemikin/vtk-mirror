...
macro(vtk_module _name)
  ...
  set(${vtk-module}_IMPLEMENTATION_REQUIRED_BY_BACKEND FALSE)
  ...
  foreach(arg ${ARGN})
    ...
    if("${arg}" MATCHES "^((|COMPILE_|PRIVATE_|TEST_|)DEPENDS|DESCRIPTION|TCL_NAME|IMPLEMENTS|IMPLEMENTATION_REQUIRED_BY_BACKEND|BACKEND|DEFAULT|GROUPS|TEST_LABELS|KIT)$")
      set(_doing "${arg}")
    ...
    elseif("${_doing}" STREQUAL "IMPLEMENTATION_REQUIRED_BY_BACKEND")
      list(APPEND ${vtk-module}_IMPLEMENTATION_REQUIRED_BY_BACKEND "${arg}")
