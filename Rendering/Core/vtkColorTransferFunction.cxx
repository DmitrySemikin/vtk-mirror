...
inline double vtkColorTransferFunctionAdjustHue(const double msh[3], double unsatM)
{
  if (msh[0] >= unsatM - 0.1)
  {
...
{
  if (x == nullptr || rgbColors == nullptr ||
    x->GetNumberOfTuples() != rgbColors->GetNumberOfTuples())
  {
