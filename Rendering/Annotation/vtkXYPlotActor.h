...
public:
  ...
  void
  AddDataSetInput(vtkDataSet *ds, const char* arrayName, int component);
  void
  AddDataSetInput(vtkDataSet *ds)
  {
    this->AddDataSetInput(ds, NULL, 0);
  }
  void
  AddDataSetInputConnection(vtkAlgorithmOutput *in, const char* arrayName,
      int component);
  void
  AddDataSetInputConnection(vtkAlgorithmOutput *in)
  {
    this->AddDataSetInputConnection(in, NULL, 0);
  }

  // Description:
  // Remove a dataset from the list of data to append.
  void
  RemoveDataSetInput(vtkDataSet *ds, const char* arrayName, int component);
  void
  RemoveDataSetInput(vtkDataSet *ds)
  {
    this->RemoveDataSetInput(ds, NULL, 0);
  }
  void
  RemoveDataSetInputConnection(vtkAlgorithmOutput *in, const char* arrayName,
      int component);
  void
  RemoveDataSetInputConnection(vtkAlgorithmOutput *in)
  {
  ...
  void
  SetPointComponent(int i, int comp);
  int
  GetPointComponent(int i);
  //---end Data Set Input-----------------------------------------------------
  ...
  SetXValuesToIndex()
  {
    this->SetXValues(VTK_XYPLOT_INDEX);
  }
  ;
  void
  SetXValuesToArcLength()
  {
    this->SetXValues(VTK_XYPLOT_ARC_LENGTH);
  }
  ;
  void
  ...
  SetXValuesToValue()
  {
    this->SetXValues(VTK_XYPLOT_VALUE);
  }
  ;
  const char *
  GetXValuesAsString();
  ...
  void
  AddDataObjectInput(vtkDataObject *in);
  void
  AddDataObjectInputConnection(vtkAlgorithmOutput *alg);

  // Description:
  // Remove a dataset from the list of data to display.
  void
  RemoveDataObjectInputConnection(vtkAlgorithmOutput *aout);
  void
  RemoveDataObjectInput(vtkDataObject *in);
  ...
  // column number.
  void
  SetDataObjectXComponent(int i, int comp);
  int
  GetDataObjectXComponent(int i);
  ...
  // column number.
  void
  SetDataObjectYComponent(int i, int comp);
  int
  GetDataObjectYComponent(int i);
  ...
  // or data object.
  void
  SetPlotColor(int i, double r, double g, double b);
  void
  SetPlotColor(int i, const double color[3])
  {
  ...
  GetPlotColor(int i);
  void
  SetPlotSymbol(int i, vtkPolyData *input);
  vtkPolyData *
  GetPlotSymbol(int i);
  void
  SetPlotLabel(int i, const char *label);
  const char *
  GetPlotLabel(int i);
  ...
  void
  SetPlotLines(int i, int);
  int
  GetPlotLines(int i);

  void
  SetPlotPoints(int i, int);
  int
  GetPlotPoints(int i);
  ...
  void
  SetPlotRange(double xmin, double ymin, double xmax, double ymax)
  {
  ...
  void
  SetAdjustXLabels(int adjust);vtkGetMacro( AdjustXLabels, int )
  ;
  void
  SetAdjustYLabels(int adjust);vtkGetMacro( AdjustYLabels, int )
  ;

  // Description:
  // Set/Get the number of minor ticks in X or Y.
  void
  SetNumberOfXMinorTicks(int num);
  int
  GetNumberOfXMinorTicks();
  void
  SetNumberOfYMinorTicks(int num);
  int
  ...
  virtual void
  SetTitleTextProperty(vtkTextProperty *p);vtkGetObjectMacro(TitleTextProperty,vtkTextProperty)
  ;
  ...
  virtual void
  SetAxisTitleTextProperty(vtkTextProperty *p);vtkGetObjectMacro(AxisTitleTextProperty,vtkTextProperty)
  ;
  ...
  // be controlled individually through the GetX/YAxisActor2D() methods.
  virtual void
  SetAxisLabelTextProperty(vtkTextProperty *p);vtkGetObjectMacro(AxisLabelTextProperty,vtkTextProperty)
  ;
  ...
  virtual void
  SetXLabelFormat(const char*);vtkGetStringMacro(XLabelFormat)
  ;

  // Description:
  // Set/Get the format with which to print the Y label.
  virtual void
  SetYLabelFormat(const char*);vtkGetStringMacro(YLabelFormat)
  ;
  ...
  void
  ViewportToPlotCoordinate(vtkViewport *viewport, double &u, double &v);
  ...
  void
  ViewportToPlotCoordinate(vtkViewport *viewport);vtkSetVector2Macro(PlotCoordinate,double)
  ...
  void
  PlotToViewportCoordinate(vtkViewport *viewport, double &u, double &v);
  ...
  // can be wrapped.)
  void
  PlotToViewportCoordinate(vtkViewport *viewport);vtkSetVector2Macro(ViewportCoordinate,double)
  ...
  int
  IsInPlot(vtkViewport *viewport, double u, double v);
  ...
  GetChartBoxProperty()
  {
    return this->ChartBoxActor->GetProperty();
  }
  ;
  ...
  void
  SetXTitlePosition(double position);
  double
  GetXTitlePosition();
  ...
  // Set plot properties
  virtual void
  SetPlotGlyphType(int, int);
  virtual void
  SetLineWidth(double);
  virtual void
  AddUserCurvesPoint(double, double, double);
  virtual void
  ...
  SetLegendBox(int);
  virtual void
  SetLegendUseBackground(int);
  virtual void
  SetLegendBackgroundColor(double, double, double);

  // Description:
  // Set title properties
  virtual void
  SetTitleColor(double, double, double);
  virtual void
  SetTitleFontFamily(int);
  virtual void
  SetTitleBold(int);
  virtual void
  SetTitleItalic(int);
  ...
  virtual void
  SetTitleVerticalJustification(int);

  // Description:
  // Set axes properties
  virtual void
  SetXAxisColor(double, double, double);
  virtual void
  SetYAxisColor(double, double, double);

  // Description:
  // Set axis title properties
  virtual void
  SetAxisTitleColor(double, double, double);
  virtual void
  SetAxisTitleFontFamily(int);
  virtual void
  SetAxisTitleBold(int);
  virtual void
  SetAxisTitleItalic(int);
  virtual void
  SetAxisTitleShadow(int);
  virtual void
  SetAxisTitleFontSize(int);
  virtual void
  SetAxisTitleJustification(int);
  virtual void
  SetAxisTitleVerticalJustification(int);

  // Description:
  // Set axis label properties
  virtual void
  SetAxisLabelColor(double, double, double);
  virtual void
  SetAxisLabelFontFamily(int);
  virtual void
  SetAxisLabelBold(int);
  virtual void
  SetAxisLabelItalic(int);
  virtual void
  SetAxisLabelShadow(int);
  virtual void
  SetAxisLabelFontSize(int);
  virtual void
  SetAxisLabelJustification(int);
  virtual void
  SetAxisLabelVerticalJustification(int);
...
protected:
  ...
  void
  ComputeXRange(double range[2], double *lengths);
  void
  ComputeYRange(double range[2]);
  void
  ComputeDORange(double xrange[2], double yrange[2], double *lengths);

  virtual void
  CreatePlotData(int *pos, int *pos2, double xRange[2], double yRange[2],
      double *norms, int numDS, int numDO);
  void
  PlaceAxes(vtkViewport *viewport, int *size, int pos[2], int pos2[2]);
  void
  GenerateClipPlanes(int *pos, int *pos2);
  double
  ComputeGlyphScale(int i, int *pos, int *pos2);
  void
  ClipPlotData(int *pos, int *pos2, vtkPolyData *pd);
  double *
  TransformPoint(int pos[2], int pos2[2], double x[3], double xNew[3]);
...
private:
  ...
  void
  operator=(const vtkXYPlotActor&); // Not implemented.

  bool
  DoesConnectionMatch(int i, vtkAlgorithmOutput* in);

  int
  IsInputPresent(vtkAlgorithmOutput* in, const char* arrayName, int component);
