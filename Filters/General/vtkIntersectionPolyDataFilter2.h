...
class VTKFILTERSGENERAL_EXPORT vtkIntersectionPolyDataFilter2 :
...
protected:
  vtkIntersectionPolyDataFilter2();  //Constructor
  ~vtkIntersectionPolyDataFilter2();  //Destructor
...
private:
  // Not implemented
  vtkIntersectionPolyDataFilter2(const vtkIntersectionPolyDataFilter2&);
  // Not implemented
  void operator=(const vtkIntersectionPolyDataFilter2&);
