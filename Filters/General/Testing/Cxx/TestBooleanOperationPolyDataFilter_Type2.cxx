/*=========================================================================
  ...
  Module:    TestBooleanOperationPolyDataFilter2.cxx
...
static vtkActor* GetCubeBooleanOperationActor( double x, int operation )
{
  ...
  vtkSmartPointer<vtkBooleanOperationPolyDataFilter2> boolFilter =
...
int TestBooleanOperationPolyDataFilter_Type2(int, char *[])
{
  ...
  //Sphere
  vtkActor *unionActor =
    GetSphereBooleanOperationActor( -2.0, vtkBooleanOperationPolyDataFilter2::VTK_UNION );
  renderer->AddActor( unionActor );
  unionActor->Delete();

  vtkActor *intersectionActor =
    GetSphereBooleanOperationActor(  0.0, vtkBooleanOperationPolyDataFilter2::VTK_INTERSECTION );
  renderer->AddActor( intersectionActor );
  intersectionActor->Delete();

  vtkActor *differenceActor =
    GetSphereBooleanOperationActor(  2.0, vtkBooleanOperationPolyDataFilter2::VTK_DIFFERENCE );
  renderer->AddActor( differenceActor );
  differenceActor->Delete();

  //Cube
  //vtkActor *unionCubeActor =
  //  GetCubeBooleanOperationActor( -2.0, vtkBooleanOperationPolyDataFilter2::VTK_UNION );
  //renderer->AddActor( unionCubeActor );
  //unionCubeActor->Delete();

  //vtkActor *intersectionCubeActor =
  //  GetCubeBooleanOperationActor(  0.0, vtkBooleanOperationPolyDataFilter2::VTK_INTERSECTION );
  //renderer->AddActor( intersectionCubeActor );
  //intersectionCubeActor->Delete();

  //vtkActor *differenceCubeActor =
  //  GetCubeBooleanOperationActor(  2.0, vtkBooleanOperationPolyDataFilter2::VTK_DIFFERENCE );
  //renderer->AddActor( differenceCubeActor );
  //differenceCubeActor->Delete();

  ////Cylinder
  //vtkActor *unionCylinderActor =
  //  GetCylinderBooleanOperationActor( -2.0, vtkBooleanOperationPolyDataFilter2::VTK_UNION );
  //renderer->AddActor( unionCylinderActor );
  //unionCylinderActor->Delete();

  //vtkActor *intersectionCylinderActor =
  //  GetCylinderBooleanOperationActor(  0.0, vtkBooleanOperationPolyDataFilter2::VTK_INTERSECTION );
  //renderer->AddActor( intersectionCylinderActor );
  //intersectionCylinderActor->Delete();

  //vtkActor *differenceCylinderActor =
  //  GetCylinderBooleanOperationActor(  2.0, vtkBooleanOperationPolyDataFilter2::VTK_DIFFERENCE );
