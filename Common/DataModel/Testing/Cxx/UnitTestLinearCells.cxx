/*=========================================================================
  ...
  Module:    UnitTestLinearCells.cxx
...
static vtkSmartPointer<vtkPolyhedron> MakePolyhedron();
...
//----------------------------------------------------------------------------
int UnitTestLinearCells(int, char*[])
{
  std::map<std::string,int> results;

  results["EmptyCell"] = TestCell<vtkEmptyCell>(VTK_EMPTY_CELL, MakeEmptyCell());
  results["Vertex"] = TestCell<vtkVertex>(VTK_VERTEX, MakeVertex());
  results["PolyVertex"] = TestCell<vtkPolyVertex>(VTK_POLY_VERTEX, MakePolyVertex());
  results["Line"] = TestCell<vtkLine>(VTK_LINE, MakeLine());
  results["PolyLine"] = TestCell<vtkPolyLine>(VTK_POLY_LINE, MakePolyLine());
  results["Triangle"] = TestCell<vtkTriangle>(VTK_TRIANGLE, MakeTriangle());
  results["TriangleStrip"] = TestCell<vtkTriangleStrip>(VTK_TRIANGLE_STRIP, MakeTriangleStrip());
  results["Polygon"] = TestCell<vtkPolygon>(VTK_POLYGON, MakePolygon());
  results["Pixel"] = TestCell<vtkPixel>(VTK_PIXEL, MakePixel());
  results["Quad"] = TestCell<vtkQuad>(VTK_QUAD, MakeQuad());
  results["Tetra"] = TestCell<vtkTetra>(VTK_TETRA, MakeTetra());
  results["Voxel"] = TestCell<vtkVoxel>(VTK_VOXEL, MakeVoxel());
  results["Hexahedron"] = TestCell<vtkHexahedron>(VTK_HEXAHEDRON, MakeHexahedron());
  results["Wedge"] = TestCell<vtkWedge>(VTK_WEDGE, MakeWedge());
  results["Pyramid"] = TestCell<vtkPyramid>(VTK_PYRAMID, MakePyramid());
  ...
  results["Polyhedron(Cube)"] = TestCell<vtkPolyhedron>(VTK_POLYHEDRON, MakeCube());
  results["Polyhedron(Dodecahedron)"] = TestCell<vtkPolyhedron>(VTK_POLYHEDRON, MakeDodecahedron());
