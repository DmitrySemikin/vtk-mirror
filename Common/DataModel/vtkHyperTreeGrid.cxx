...
//----------------------------------------------------------------------------
vtkUnsignedCharArray* vtkHyperTreeGrid::GetGhostArray(int type)
{
  switch (type)
  {
    case CELL:
...
//-----------------------------------------------------------------------------
vtkUnsignedCharArray* vtkHyperTreeGrid::GetCellGhostArray()
{
...
//----------------------------------------------------------------------------
vtkUnsignedCharArray* vtkHyperTreeGrid::AllocateCellGhostArray()
{
