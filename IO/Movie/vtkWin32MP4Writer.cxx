...
class vtkWin32MP4Writer::vtkWin32MP4WriterInternals
{
public:
  // Format constants
  UINT32 VideoWidth = 0;
...
//------------------------------------------------------------------------------
vtkStandardNewMacro(vtkWin32MP4Writer);

//------------------------------------------------------------------------------
vtkWin32MP4Writer::vtkWin32MP4Writer()
{
  this->BitRate = 800000;
  this->FrameRate = 10;

  this->Internals = new vtkWin32MP4WriterInternals();
}
