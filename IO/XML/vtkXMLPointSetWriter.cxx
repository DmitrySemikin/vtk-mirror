...
//------------------------------------------------------------------------------
void vtkXMLPointSetWriter::WriteInlinePieceAttributes()
{
...
//------------------------------------------------------------------------------
void vtkXMLPointSetWriter::WriteInlinePiece(vtkIndent indent)
{
...
//------------------------------------------------------------------------------
void vtkXMLPointSetWriter::WriteAppendedPieceAttributes(int index)
{
...
//------------------------------------------------------------------------------
void vtkXMLPointSetWriter::WriteAppendedPiece(int index, vtkIndent indent)
{
...
//------------------------------------------------------------------------------
void vtkXMLPointSetWriter::WriteAppendedPieceData(int index)
{
...
//------------------------------------------------------------------------------
void vtkXMLPointSetWriter::CalculateSuperclassFraction(float* fractions)
{
  vtkPointSet* input = this->GetInput();
